...
at
\weblink{https://github.com/claudio-tw/minerva/tree/trunk/experiments/experiment\_1}{minerva/experiments/experiment\_1}.\footnote{
	See
...
See
\weblink{https://scikit-learn.org/stable/modules/generated/sklearn.feature\_selection.mutual\_info\_regression.html}{https://scikit-learn.org/stable/modules/generated/sklearn.feature\_selection.mutual\_info\_regression.html}.
}
...
See
\weblink{https://pypi.org/project/arfs/}{https://pypi.org/project/arfs/}.
}


Data and code for our experiments are available 
at
\weblink{https://github.com/claudio-tw/minerva/tree/trunk/experiments/experiment\_2}{minerva/experiments/experiment\_2}.\footnote{
	See
\weblink{https://github.com/claudio-tw/minerva/tree/trunk/experiments}{https://github.com/claudio-tw/minerva/tree/trunk/experiments}.
}
More precisely, 
the synthetic dataset that we use is
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/data/large.csv}{minerva/experiments/experiment\_2/data/large.csv},\footnote{
See
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/data/large.csv}{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/data/large.csv}.
}
and 
the script used for training minerva is
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/minervarunner.py}{minerva/experiments/experiment\_2/minervarunner.py}.\footnote{
	See
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/minervarunner.py}{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/minervarunner.py}.
}
The training history of the 
selection weights
in the vector $p$
is available at
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/data/run4/weight\_history\_7\_segment0.csv}{weight\_history.csv}.\footnote{
	See
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/data/run4/weight\_history\_7\_segment0.csv}{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/data/run4/weight\_history\_7\_segment0.csv}.
}
% and 
% Tensorboard logs are available at
% \weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/tb\_logs/experimnet\_2/run4}{tb\_logs/experiment\_2}.\footnote{
% 	See
% 	\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/tb\_logs/experimnet\_2/run4}{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/tb\_logs/experimnet\_2/run4}.
% }
The benchmark methods of feature selection 
were
executed
in the script
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/benchmarks.py}{minerva/experimnets/experiment\_2/benchmarks.py}.\footnote{
	See
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/benchmarks.py}{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/benchmarks.py}.
}
...
the featurese selected by the other methods.
See 
Table \ref{tab.experiment2accuracy}
and
the notebook
\weblink{https://github.com/claudio-tw/minerva/blob/trunk/experiments/experiment\_2/accuracy.ipynb}{accuracy.ipynb}
