...
\weblink{https://github.com/claudio-tw/minerva}{minerva}.\footnote{
	See
	\weblink{https://github.com/claudio-tw/minerva}{https://github.com/claudio-tw/minerva}.
}
Its usage is demonstrated 
with Jupyter notebooks
at
\weblink{https://github.com/claudio-tw/minerva/tree/trunk/notebooks}{https://github.com/claudio-tw/minerva/tree/trunk/notebooks}.
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\UNTIL{$v(\varphi, p) > v(\theta, \ones) - \delta$}
